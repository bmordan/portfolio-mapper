...
const getPercentageOfCompetency = (competency, tags) => {
    ...
    const tagged = tags.reduce((set, comment) => {
    ...
    // calculate '2 of 3' and '1 of 3' thats 66.666% of a single competency
    return override ? 100 : Number(((100 / bulletPoints.length) * tagged.size).toFixed(3)) || 100
}
